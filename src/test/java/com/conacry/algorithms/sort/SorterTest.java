...
public class SorterTest {
    ...
    @Test
    public void sort_getMergeSort_sortedDirectArray() {
        long[] array = { 2, 1, 4, 6, 3, 5 };
        long[] sortedArray = { 1, 2, 3, 4, 5, 6 };

        Sorter sorter = SorterFactory.getSorter(SorterType.MERGE_SORT, Order.DIRECT);
        sorter.sort(array);
    ...
    @Test
    public void sort_getMergeSort_sortedReverceArray() {
        long[] array = { 2, 1, 4, 6, 3, 5 };
        long[] sortedArray = { 6, 5, 4, 3, 2, 1 };
    ...
    @Test
    public void sort_getQickSort_sortedDirectArray() {
        long[] array = { 2, 1, 4, 6, 3, 5 };
        long[] sortedArray = { 1, 2, 3, 4, 5, 6 };
    ...
    @Test
    public void sort_getQuickSort_sortedReverceArray() {
        long[] array = { 2, 1, 4, 6, 3, 5 };
        long[] sortedArray = { 6, 5, 4, 3, 2, 1 };

        Sorter sorter = SorterFactory.getSorter(SorterType.QUICK_SORT, Order.REVERSE);
        sorter.sort(array);
